...
const shuffleCards = () => {
  ...
  ;[...cards, ...cards]
    ...
    .forEach((item, index) => {
      const currentItem: Card = { ...item, id: btoa(String(index)), isFlipped: true }
...
export default { cardItems, countFounded, shuffleCards, validationCards, currentCards, setCurrentCards, validateTwoCurrentCard }
